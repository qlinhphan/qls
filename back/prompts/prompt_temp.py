...
def llama_clients_prompt(knowledge, context, q):
    ...
    prompt = f"""
        ...
        (Dựa vào {knowledge}, có bao nhiêu chuyên khoa phù hợp thì bạn liệt kê ra bấy nhiêu chuyên khoa theo đúng cấu trúc bên dưới. Nếu chỉ có 1 khoa thì chỉ in ra 1 lần, nếu có nhiều khoa thì lặp lại khối này tương ứng, đặc biệt cùng một khoa/khám thì không được lặp lại):
